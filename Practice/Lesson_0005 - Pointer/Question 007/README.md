# Write a program that will ask the user to enter the width and length of a rectangle, and then display the rectangle’s area. The program calls the following functions: 
  ...
  - displayData - this function should accept the rectangle’s length, width, and area as reference arguments, and display them in an appropriate message on the screen. 
